...
season = input("Enter your current season name: ")
season = season.encode("utf-8")
print(f"Your string encoded as the 'utf-8'-string: {season}.")
season = season.decode("utf-8")
print(f"Your string decoded as the 'utf-8'-string: {season}.")
